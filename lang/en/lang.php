...
return [
    ...
    'setting' => [
        ...
        'datev_shipping_revenue_account' => 'Shipping revenue 19% (contra account)',
        'datev_shipping_revenue_account_comment' => 'Contra account for the shipping fee (credit), 19% VAT, e.g. SKR03 8400 / SKR04 4400. Leave empty to keep shipping on the liability account (split by the tax advisor).',
        'datev_shipping_vat_key' => 'Shipping VAT key (19%)',
        'datev_shipping_vat_key_comment' => 'DATEV tax key for the 19% VAT on shipping. Leave empty for an automatic revenue account.',
    ...
    'receipt' => [
        ...
        'fee_net_label'        => 'Shipping (net)',
        'fee_vat_label'        => 'incl. :rate % VAT (shipping)',
        'total_label'          => 'Total',
        'payment_label'        => 'Payment method:',
        'reference_label'      => 'Reference:',
        'payment_banktransfer' => 'Bank transfer (prepayment)',
        'payment_online'       => 'Online payment (Mollie)',
        'note_multi_purpose'   => 'Multi-purpose voucher under § 3 (15) UStG: no VAT is shown on the voucher value; it becomes due only when the voucher is redeemed.',
        'note_single_purpose'  => 'Single-purpose voucher under § 3 (14) UStG: the VAT shown becomes due already on issuance of the voucher.',
        'note_fee_vat'         => 'The shipping service fee is a separate supply and includes 19% VAT.',
    ],
    ...
    'mail' => [
        ...
        'label_recipient'            => 'Gift recipient:',
    ...
    'purchase' => [
        ...
        'recipient_optional'  => 'Gift recipient (optional)',
    ...
    'pos' => [
        ...
        'sold_write_code_lead'   => 'Write this code on the card:',
        'detail_value'           => 'Value',
