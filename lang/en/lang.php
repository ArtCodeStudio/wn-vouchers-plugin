...
return [
    ...
    'field' => [
        ...
        'valid_until_comment'     => 'Empty = default validity from the settings (default: 3 years to year-end). A different date can be set here.',
        'issued_at'               => 'Issued at',
        'created'                 => 'Created',
        'date'                    => 'Date',
    ...
    'setting' => [
        ...
        'validity_years_comment' => 'Default validity, rounded up to year-end — matches the statutory 3-year limitation in Germany (§§195/199 BGB). 0 = print no expiry date.',
